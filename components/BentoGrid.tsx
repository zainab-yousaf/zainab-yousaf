            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                >
                    <div className="space-y-3">
                        <p className="text-xs text-[#9a9a92]">Flagship project · Jan 2026 – Present</p>
                        <h3 className="text-xl font-semibold text-white">DreamDesk: Hotel AI Agent Platform</h3>
                        <p className="text-sm text-[#c0c0b8] leading-relaxed">
                            Autonomous hotel guest communications platform. A 4-layer multi-agent graph handles bookings, FAQs, and service requests across email, chat, voice, and WhatsApp with zero human intervention required.
                        </p>
                        <div className="flex flex-wrap gap-2 pt-1">
                            {["Pydantic AI", "RAG", "Pinecone", "MCP", "Gemini 2.5", "Next.js", "Logfire"].map(t => (
                                <span key={t} className="inline-block text-xs px-2.5 py-1 rounded-full" style={{ background: "rgba(255,255,255,0.1)", color: "#e5e5e3" }}>{t}</span>
                            ))}
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3 mt-6 pt-6" style={{ borderTop: "0.5px solid rgba(255,255,255,0.1)" }}>
                        {[
