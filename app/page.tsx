            ...
            <main className="ml-64 w-full">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold mb-6 bg-gradient-to-r from-white via-blue-200 to-purple-200 bg-clip-text text-transparent animate-slide-up">
                            Hi, I'm{" "}
